...
//Creates the slider and chart responses to slider
var sliderObjTest = {};
...
d3.select("#timeSlider").on("input", function() {
 ...
 var sliderValue = sliderFreeInput.addEventListener('input', function() {
    return(this.value)
});

////////////////Render Line Chart///////////////////////
function renderlinechart(data, sliderValue2){
  var test = d3.selectAll('.chartsContainer')
                .append('div')   
                
                
sliderFreeInput.addEventListener('input', function () {
 ...
 var year = update(1995);
 update(year)
///Pull slider value into each chart
...
// console.log(sliderValue)
   ...
   var line = d3.line()
    ...
    ///////TOOLTIPS
    var focus = svg
        // d3.selectAll(function(){return "." + data[0].class + "_svg"})
        // .datum(data)
        .append("g")
        .attr("class","focus")
        .style("display", "none");
  ...
  console.log(sliderObjTest.test);
...
d3.csv("data/malawi_landsat_5_7_8_1990-2018.csv").then(function(data) {
    ...
    d3.csv("data/worldBank.csv").then(function(data) {
            ...
            renderlinechart(gdp, sliderValue);
            renderlinechart(agriculture, sliderValue);
